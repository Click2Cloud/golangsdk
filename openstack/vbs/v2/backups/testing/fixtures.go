...
// HandleListSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/backups/detail` on the test handler mux
// that responds with a `List` response.
func HandleListSuccessfully(t *testing.T, output string) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backups/detail", func(w http.ResponseWriter, r *http.Request) {
...
func HandleGetSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backups/87566ed6-72cb-4053-aa6e-6f6216b3d507", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
		w.Header().Add("Content-Type", "application/json")
		w.WriteHeader(http.StatusOK)
...
// HandleCreateSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/backups` on the test handler mux
// that responds with a `Create` response.
func HandleCreateSuccessfully(t *testing.T, output string) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/cloudbackups", func(w http.ResponseWriter, r *http.Request) {
...
// HandleDeleteSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/backups/87566ed6-72cb-4053-aa6e-6f6216b3d507`
...
// HandleRestoreSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/backups/87566ed6-72cb-4053-aa6e-6f6216b3d507/restore` on the test handler mux
// that responds with a `Create` response.
func HandleRestoreSuccessfully(t *testing.T, output string) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backups/87566ed6-72cb-4053-aa6e-6f6216b3d507/restore", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "POST")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
