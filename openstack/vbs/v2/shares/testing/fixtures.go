...
// HandleGetSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing/ac0fb374-a288-4399-ac63-cc080a13a2ee`
// on the test handler mux that responds with a `Get` response.
func HandleGetSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing/ac0fb374-a288-4399-ac63-cc080a13a2ee", func(w http.ResponseWriter, r *http.Request) {
...
// HandleCreateSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing` on the test handler mux
// that responds with a `Create` response.
func HandleCreateSuccessfully(t *testing.T, output string) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing", func(w http.ResponseWriter, r *http.Request) {
...
// HandleDeleteSuccessfully creates an HTTP handler at `/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing/87566ed6-72cb-4053-aa6e-6f6216b3d507`
// on the test handler mux that responds with a `Delete` response.
func HandleDeleteSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/os-vendor-backup-sharing/87566ed6-72cb-4053-aa6e-6f6216b3d507", func(w http.ResponseWriter, r *http.Request) {
