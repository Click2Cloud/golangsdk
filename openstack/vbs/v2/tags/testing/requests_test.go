...
func TestCreateV2Tag(t *testing.T) {
	...
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backuppolicy/ed8b9f73-4415-494d-a54e-5f3373bc353d/tags", func(w http.ResponseWriter, r *http.Request) {
...
func TestDeleteV2Tag(t *testing.T) {
	...
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backuppolicy/ed8b9f73-4415-494d-a54e-5f3373bc353d/tags/K1", func(w http.ResponseWriter, r *http.Request) {
...
func TestBatchActionsV2Tag(t *testing.T) {
	th.SetupHTTP()
	defer th.TeardownHTTP()
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backuppolicy/ed8b9f73-4415-494d-a54e-5f3373bc353d/tags/action", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "POST")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
...
func TestQueryV2Tags(t *testing.T) {
	...
	th.Mux.HandleFunc("/17fbda95add24720a4038ba4b1c705ed/backuppolicy/resource_instances/action", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "POST")
		th.TestHeader(t, r, "X-Auth-Token", fake.TokenID)
